...
public final class MinecordPlugin extends JavaPlugin{
    ...
    public void connectMinecord(MinecordPlayer p, boolean connect){
        if(connect){
    ...
    public void updatePresence(MinecordPlayer p, RichPresence presence){
